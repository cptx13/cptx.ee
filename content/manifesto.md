...
cptx.ee is a self-hosted Go application running on an [exe.dev](https://exe.dev) VM, built with [htmlc](https://github.com/dhamidi/htmlc), [dispatch](https://github.com/dhamidi/dispatch), and [goldmark](https://github.com/yuin/goldmark). All content is written in markdown. The source code lives on [GitHub](https://github.com/cptx13/cptx.ee); photos live on the server.
...
- **[croquis](/categories/croquis/)** are quick, often rough notes made to capture the essence or form of a subject that may lead to more detailed work.
...
- **[photos](/photos/)** are collections of photographs from various places and years, served directly from the server.
